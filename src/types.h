...
constexpr Value PawnValue   = 217;
constexpr Value KnightValue = 791;
constexpr Value BishopValue = 784;
constexpr Value RookValue   = 1362;
constexpr Value QueenValue  = 2730;
