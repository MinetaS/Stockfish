...
constexpr Value PawnValue   = 202;
constexpr Value KnightValue = 753;
constexpr Value BishopValue = 841;
constexpr Value RookValue   = 1267;
constexpr Value QueenValue  = 2459;
