...
constexpr int FwdOutMultipliersBig[LayerStacks]   = {571, 609, 578, 588, 600, 587, 579, 572};
constexpr int FwdOutMultipliersSmall[LayerStacks] = {620, 588, 720, 578, 639, 592, 598, 630};
