...
constexpr int FwdOutMultipliersBig[LayerStacks]   = {596, 589, 606, 610, 609, 587, 600, 593};
constexpr int FwdOutMultipliersSmall[LayerStacks] = {614, 602, 648, 568, 587, 604, 637, 594};
