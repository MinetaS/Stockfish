...
class AffineTransform {
   public:
    ...
    static constexpr IndexType PaddedInputDimensions =
      ceil_to_multiple<IndexType>(InputDimensions, BufferAlignment);
    static constexpr IndexType PaddedOutputDimensions =
      ceil_to_multiple<IndexType>(OutputDimensions, BufferAlignment);
...
\
   public: \
    ...
    #include "arch/aarch64/nnue/layers/affine_transform.h"
