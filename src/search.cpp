...
Value to_corrected_static_eval(Value v, const Worker& w, const Position& pos) {
    // clang-format off
    // gcc will not vectorize fc0 loop if the array size is not a multiple of 8.
    static constexpr std::int32_t fc0w[8][8] = {
        { 7, 25, -4, -24, 18, 5 },
        { -25, 1, -2, -4, 6, 4 },
        { 2, -1, -11, 0, -19, -22 },
        { -1, -11, -1, 1, -3, 12 },
    ...
    static constexpr std::int32_t fc0b[8] = {
        10, -13, -12, -21, 40, 20, -6, -9
    };
    static constexpr std::int32_t fc1w[8][8] = {
        { -11, 57, -5, 7, 30, -33, 37, 1 },
        { 3, -29, -2, -4, -12, 10, -1, 42 },
        { -21, 11, -34, 29, 13, -10, 13, 16 },
        { 39, 12, 19, 48, -16, -6, -10, -1 },
        { -7, 40, -32, 3, -17, -27, 22, 21 },
        { -7, -7, 11, -5, -18, 16, -19, -7 },
        { -10, -1, 7, -10, -4, -9, 4, 11 },
        { -9, -7, -29, 32, 13, -9, -38, -11 }
    };
    static constexpr std::int32_t fc1b[8] = {
        -6, -25, -20, 186, -6, 6, -2, -24
    };
    static constexpr std::int32_t fc2w[8] = {
        -2, 29, 36, 1, 10, -20, -10, -15
    };
    static constexpr std::int32_t fc2b = 43;
    // clang-format on
