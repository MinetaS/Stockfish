...
int correction_value(const Worker& w, const Position& pos, const Stack* const ss, int depth) {
    ...
    return (9536 * pcv + 8494 * micv + 10132 * (wnpcv + bnpcv) + 7156 * cntcv) * std::max(10 - depth, 8) / 8;
}
