...
Value Eval::evaluate(const Position& pos, int* complexity) {
  ...
  bool useClassical = !useNNUE || (pos.count<ALL_PIECES>() > 7 && abs(psq) > 1805);
  ...
  else
  {
      ...
      nnueComplexity = (  376 * nnueComplexity
                        + 423 * abs(psq - nnue)
      ...
      optimism = optimism * (253 + nnueComplexity) / 256;
      v = (nnue * scale + optimism * (scale - 752)) / 1024;
  }

  // Damp down the evaluation linearly when shuffling
  v = v * (197 - pos.rule50_count()) / 209;
